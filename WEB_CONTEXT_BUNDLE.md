...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-011-0012-some-questions-question-12-b3bfdd3b",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-011-0012-e35918a3641f",
        "url": "https://www.unsolvedmath.com/problems/AMR-011-0012"
      }
    ],
    "statement": {
      "language": "en",
      "text": "For a locally convergent sequence $(G_n)$ of bounded-degree integer-labeled graphs, does the normalized rank modulo $p$ of the adjacency matrix converge?",
      "version": 1
    },
    "title": "Some Questions — Question 12",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "667ffda25fb995deed2a22e4caa21065a88d2c42a80a0b54d8a6961feed033db"
}
```
